...
<p><?php printf( esc_html__( 'Danke, dass du ein Konto bei %1$s erstellt hast. Dein Benutzername ist %2$s. Du kannst auf deinen Kontobereich zugreifen, um Bestellungen einzusehen, dein Passwort zu ändern, deine Kurse einzusehen und vieles mehr unter: %3$s', 'woocommerce' ), esc_html( $blogname ), '<strong>' . esc_html( $user_login ) . '</strong>', make_clickable( esc_url( wc_get_page_permalink( 'myaccount' ) ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
